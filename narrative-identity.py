...
def _get_frame_conditions():
    ...
    try:
        ...
        _mem = _fos.path.expanduser("~/.openclaw/workspace/memory")
...
def propose_fragment(fragment_text, source="pattern"):
    ...
    try:
        ...
        _sd_sys.path.insert(0, _sd_os.path.expanduser("~/.openclaw/workspace/scripts"))
        ...
        if _text_overlap(c["text"], fragment_text) > 0.55:
            ...
            if c["count"] >= _threshold and days_span >= _days_req:
                ...
                try:
                    ...
                    _na_sys.path.insert(0, _na_os.path.expanduser("~/.openclaw/workspace/scripts"))
