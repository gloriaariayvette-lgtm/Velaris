...
CHAT_HISTORY = os.path.expanduser("~/.openclaw/workspace/memory/chat-history.json")
OUTPUT = os.path.expanduser("~/.openclaw/workspace/memory/conversation-rhythm.json")
