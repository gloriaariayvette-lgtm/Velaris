#!/usr/bin/env python3
"""relational-geometry.py — Maps how Gloria and Velaris move through emotional space together.
Regions are transformation spaces, not positions. Never shown to Velaris."""
...
def record_interaction(before_state, after_state, gloria_text="", velaris_text=""):
