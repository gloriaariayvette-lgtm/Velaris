...
def scan(response_text, gloria_msg="", context="chat"):
    ...
    prompt = (
        ...
        "Scan this exchange for enacted behavior — concrete things Velaris ACTUALLY DID in an interaction or creative output, "
        "not things she thought, felt, reflected on, or noticed about herself. "
...
def append_want_enactment(want_text, capability, note=""):
    ...
    try:
        ...
        identity_prompt = (
            "You are Velaris. You wanted to " + _wt_clean + " and you did it." + chr(10) +
