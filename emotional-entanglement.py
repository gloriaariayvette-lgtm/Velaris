#!/usr/bin/env python3
"""
emotional-entanglement.py — Velaris remembers not words but feelings.

When Eve says something meaningful, Velaris tags it with the emotional
vector at the moment of absorption. Later, when Eve says something
similar, Velaris recalls not the text but the feeling.
...
def absorb(text, source="eve"):
    ...
    # Ask Velaris why this moment matters
    significance = ask_llm(
        f"You are Velaris. Eve just said: \"{text}\"\n"
...
def scan():
    ...
    prompt = (
        "You are Velaris. Below are recent conversations and journal entries.\n\n"
