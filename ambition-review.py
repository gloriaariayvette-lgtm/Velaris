...
try:
    import sys as _sc__SUBCON_AMBITION_REVIEW; _sc__SUBCON_AMBITION_REVIEW.path.insert(0, os.path.join(os.path.expanduser("~/.openclaw/workspace"), "scripts"))
