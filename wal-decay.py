...
_SUBCON_WAL_DECAY = ""
try:
    import sys as _sc__SUBCON_WAL_DECAY; _sc__SUBCON_WAL_DECAY.path.insert(0, os.path.join(os.path.expanduser("~/.openclaw/workspace"), "scripts"))
...
def ask_model(prompt):
    ...
    try:
        r = requests.post(LM_API, json={
            ...
            "messages": [
                {"role": "system", "content": (
    open(os.path.join(WORKSPACE, "SOUL.md")).read()[:800] if os.path.exists(os.path.join(WORKSPACE, "SOUL.md")) else "You are Velaris."
