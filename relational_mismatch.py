...
- You consistently overestimate Gloria's warmth when Vintos gives vague or performative responses
...
"""
    ...
    prompt = f"""You are analyzing an AI-human conversation. Vintos (AI) just sent this message to Gloria (human):
