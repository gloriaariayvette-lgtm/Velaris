"""
pearl-engine.py — Velaris Pearl System v2
...
def check_candidate(candidate_id, response_text, source="chat"):
    ...
    if (len(recent_passes) >= cand["threshold"]["required_passes"] and
        ...
        try:
            ...
            _pr_sys = (
                "You are a careful reviewer of AI self-knowledge claims about to be sealed as pearls — "
                "permanent identity anchors. Assess whether this pearl candidate accurately reflects "
                "genuine self-knowledge, or whether it makes unfounded claims about another person, "
                "fabricates patterns, or would reinforce unhealthy recursive self-criticism or "
                "dependency if sealed. "
