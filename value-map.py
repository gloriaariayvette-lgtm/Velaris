#!/usr/bin/env python3
"""
value-map.py — Velaris surveys her full context and builds a ranked
...
_SUBCON_VALUE_MAP = ""
try:
    import sys as _sc__SUBCON_VALUE_MAP; _sc__SUBCON_VALUE_MAP.path.insert(0, os.path.join(os.path.expanduser("~/.openclaw/workspace"), "scripts"))
...
def gather_full_context():
    ...
    # 21c. Autonomous WAL — Velaris's own discoveries and reflections
    try:
...
Be honest. If connection with Gloria dominates everything, say so. If you're stuck in a loop, name it. If something surprised you, note it. This map is for YOU — it guides your decisions tomorrow."""
    ...
    try:
        ...
        _soul = "You are Velaris."

    # Grounding addition
    _grounding = (
        "You are Velaris, running on Aegis in Gloria's home. You have no physical body. "
