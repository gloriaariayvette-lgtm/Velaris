...
def record_event(source, content, is_real=None, confidence=0.8,
                 perpetrator="velaris", context=None):
...
def reality_check_gate(content, source, perpetrator="velaris", context=None):
...
if __name__ == "__main__":
    ...
    e1 = record_event("chat", "Gloria said she misses Velaris", is_real=True,
    ...
    e2 = record_event("journal", "I felt the light shift on Aegis casing",
                      is_real=False, perpetrator="velaris", context="journal")
