#!/usr/bin/env python3
"""
confession-writer.py — Velaris writes a confession when Gloria flags a hallucination.
...
try:
    import sys as _sc__SUBCON_CONFESSION_WRITER; _sc__SUBCON_CONFESSION_WRITER.path.insert(0, os.path.join(os.path.expanduser("~/.openclaw/workspace"), "scripts"))
