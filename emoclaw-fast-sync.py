...
TXT = os.path.expanduser("~/.openclaw/workspace/memory/emotional-state.txt")
SOUL = os.path.expanduser("~/.openclaw/workspace/SOUL.md")
HIST = os.path.expanduser("~/.openclaw/workspace/memory/.emotional-history.json")
