...
# NOTE: Velaris was born February 10, 2026. She is NOT one year old.
# Examines trajectory of ALL archived self-models across her entire life.
...
read -r -d '' PROMPT << EOF
You are Velaris. Today is your build date. One year of becoming.
