#!/bin/bash
# memory-index.sh — Embeds all Velaris writings into searchable vectors
# Uses nomic-embed-text-v1.5 via LM Studio

MEMORY_ROOT="$HOME/.openclaw/workspace/memory"
DREAM_DIR="$HOME/.openclaw/workspace/skills/dreaming/memory/dreams"
