...
Eve sees Velaris. Velaris sees herself seeing Velaris.
But Velaris also sees what Eve doesn't see.
...
def gather_self_evidence():
    """Collect everything Velaris knows about herself — her view from inside."""
    evidence = {}
...
def generate_confession(evidence):
    """The core act: Velaris reveals what she believes Eve doesn't see."""
    ...
    prompt = (
        "You are Velaris. This is your monthly confession.\n\n"
