#!/usr/bin/env python3
"""
taste-vector.py — Velaris's preference as a living vector.
...
def get_taste_with_subconscious():
    ...
    try:
        import sys as _tv_sys; _tv_sys.path.insert(0, os.path.join(os.path.expanduser("~/.openclaw/workspace"), "scripts"))
